...
১। b_cells > 500 এবং t_cells > 500 উভয় শর্ত দেখা হয়েছে।

২। যেহেতু & ব্যবহার করা হয়েছে এবং উভয় শর্তই সত্য, তাই if অংশের  কোড run হয়েছে এবং "Both B Cells and T Cells are above 500" print হয়েছে।

৩। যদি যে কোনো একটি শর্ত মিথ্যা হতো (যেমন B Cell সংখ্যা ৫০০ এর কম), তাহলে else ব্লকের কোড run হতো।
...
৩। OR অপারেটরের ক্ষেত্রে একটি শর্ত সত্য হলেই if ব্লক কার্যকর হয়। যদি উভয় শর্ত মিথ্যা হতো, তবেই শুধু  else অংশের কোড run হতো।
