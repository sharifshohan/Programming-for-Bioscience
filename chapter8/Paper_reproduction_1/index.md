...
আমি এই লেখায় এই গবেষণার প্রতিটি অংশ ব্যাখ্যা করার চেষ্টা করবো এবং একইসাথে R প্রোগ্রামিং এর মাধ্যমে ওই অংশের ডেটা বিশ্লেষণ করে দেখাব। এই গবেষণার একটি ভাল দিক হচ্ছে ওরা ডেটা আলাদা করে দিয়ে দিয়েছে। প্রতিটি বিশেলশন এ আপনারা দেখবেন বামদিকের অংশতই আমার তৈরি করা আর ডানদিকেরটি পেপার এ দেওয়া।  আপনি চাইলে ডেটা এখান থেকে [Download](./Mettelman_Minimum_dataframe.csv) করে নিতে পারবেন। 
